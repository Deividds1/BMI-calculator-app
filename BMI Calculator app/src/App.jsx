...
function App() {
  ...
  const calcRange = (height) => {
    ...
    setWeightRange(`${low.toFixed(1)}kgs - ${high.toFixed(1)}kgs.`);
  };
  ...
  const isInputsFilled = weight !== '' && height !== '';
    ...
    <>
      <div className="container">
            ...
            {isInputsFilled &&
              <div className="results-card">
                <div className="bmi-score">
                  <p><strong>BMI is... {result}</strong></p>

                  <p className="results"></p>
                </div>
                <p className="results-summary">
                  Your BMI suggests you're...<span className="classification">{category}</span>. Your ideal weight is between <strong className="ideal">{weightRange}</strong>
                </p>
              </div>
            }
            <div className="results-card placeholder">
              <h3>Welcome!</h3>
              <p>Please enter your height and weight to see your BMI.</p>
            </div>
          </form>
        </header>

        <section className="summary">
          <img src={manEating} alt="man eating sushi" />
        ...
        <section className="tips">
          <div className="eating tips-card">
            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="0 0 64 64">
